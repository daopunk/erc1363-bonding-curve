...
contract BancorFormula is Power {
    ...
    function calculatePurchaseReturn(
        ...
        if (_connectorWeight == _MAX_WEIGHT) {
        ...
        (result, precision) = _power(baseN, _connectorBalance, _connectorWeight, _MAX_WEIGHT);
    ...
    function calculateSaleReturn(
        ...
        (result, precision) = _power(_supply, baseD, _MAX_WEIGHT, _connectorWeight);
